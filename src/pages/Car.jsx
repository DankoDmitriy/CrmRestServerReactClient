...
import CarAddFrom from "../components/car/CarAddFrom";
...
const Car = () => {
    ...
    async function fetchItem() {
        const response = await CarService.getAll(currentPage, pageSize);
        ...
        <div className="App">
            ...
            <Container mt={5}>
                ...
                <MyModal visible={addItemVisibleFlag}
                    ...
                    <CarAddFrom updateItemsListAfterAction={updateItemsListAfterAction}/>
                </MyModal>
