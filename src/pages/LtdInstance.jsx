...
import LtdInstanceAddForm from "../components/ltdInstance/LtdInstanceAddForm";
import LtdInstanceList from "../components/ltdInstance/LtdInstanceList";
...
const LtdInstance = () => {
    ...
    async function fetchItem() {
        const response = await LtdInstanceService.getAll(currentPage, pageSize);
            ...
            <Container fluid>
                {
                    ...
                    <Button style={{marginTop: 10, marginBottom: 10}} onClick={() => setAddItemVisibleFlag(true)}>
                        {t('ltdInstance.addLtdInstanceButton')}
                    </Button>
                }
                <MyModal visible={addItemVisibleFlag}
                         setVisible={setAddItemVisibleFlag}>
                    <LtdInstanceAddForm updateItemsListAfterAction={updateItemsListAfterAction}/>
                </MyModal>

                <LtdInstanceList items={items}
